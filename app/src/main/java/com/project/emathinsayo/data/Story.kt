...
enum class Quiz(
    ...
    // Adding Fractions
    ADDITION_FRACTION_QUIZ1(1, "1/4 + 1/4 = ?", listOf("2/8", "1/2", "2/4","1/3"), 2),
    ADDITION_FRACTION_QUIZ2(2, "2/5 + 1/5 = ?", listOf("3/5", "2/5", "4/5","2/3"), 1),
    ADDITION_FRACTION_QUIZ3(3, "1/3 + 2/3 = ?", listOf("2/3", "1", "1/3","1/2"), 2),
    ADDITION_FRACTION_QUIZ4(4, "3/8 + 1/8 = ?", listOf("4/16", "1/2", "1/4","3/4"), 2),
    ADDITION_FRACTION_QUIZ5(5, "5/6 + 1/6 = ?", listOf("1", "1/6", "0","1/2"), 1),
    ADDITION_FRACTION_QUIZ6(6, "1/2 + 1/4 = ?", listOf("2/6", "3/4", "4/12","1/4"), 2),
    ADDITION_FRACTION_QUIZ7(7, "2/3 + 1/6 = ?", listOf("3/9", "5/6", "3/6","6/5"), 2),
    ADDITION_FRACTION_QUIZ8(8, "1/5 + 3/10 = ?", listOf("1/2", "4/15", "1/4","1/3"), 1),
    ADDITION_FRACTION_QUIZ9(9, "2/7 + 3/14 = ?", listOf("5/21", "7/14", "9/14","6/14"), 2),
    ADDITION_FRACTION_QUIZ10(10, "1/4 + 3/8 = ?", listOf("4/12", "5/8", "8/12","2/11"), 2),
    ADDITION_FRACTION_QUIZ11(11, "1/3 + 1/6 + 1/2 = ?", listOf("5/6", "1 1/6", "16/6", "1/12"), 2),
    ADDITION_FRACTION_QUIZ12(12, "2/5 + 1/10 + 1/2 = ?", listOf("4/17", "1 1/10", "4/10","1 1/2"), 2),
    ADDITION_FRACTION_QUIZ13(13, "3/4 + 1/8 + 1/2 = ?", listOf("1 3/8", "5/8", "8/8","1 1/8"), 1),
    ADDITION_FRACTION_QUIZ14(14, "1/6 + 2/3 + 1/12 = ?", listOf("3/11", "11/12", "4/11","12/11"), 2),
    ADDITION_FRACTION_QUIZ15(15, "5/12 + 1/4 + 1/3 = ?", listOf("11/12", "7/12", "8/12","12/11"), 1),
